...
class FRP_BS_class: public Model_1D
	{
	public:	
		FRP_BS_class (const Real rate,const Real dyield,const Real sigma, const int lower=0,const int upper=0);
		~FRP_BS_class();
	...
	void Make_Green_Put_yydtSI( const int lenx, const int leny, 
		...
		Real *x, *y,*yint;
		double dL;
		Matrix mG,Call_maturity_mG,Call_dyield_mG,Call_DD_mG,Call_0d_mG;
        BandMatrix bG,Call_maturity_bG,Call_dyield_bG,Call_DD_bG,Call_0d_bG;
